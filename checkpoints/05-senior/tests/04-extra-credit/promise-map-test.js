...
describe.only('▒▒▒ Extra Credit tests ▒▒▒', function () {
  ...
  describe('Promise.map', () => {
    ...
    describe('returning a promise from the iterator', () => {
      ...
      it('maintains the order of the input array', () => {
      ...
      it('rejects the map promise if iterator returns a promise that rejects', () => {
    ...
    describe('promises in input array', () => {
      ...
      it('calls the iterator function with the resolved value of the promise', () => {
      ...
      it('rejects the map promise if a promise in the input array rejects', () => {
